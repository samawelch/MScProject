...
Flow cytometric cell counts (Accuri C6 Flow Cytometer) were linearly modelled against optical density in an attempt to transform OD reading into absolute cell counts. However, no significant relationship was found between the two measurements, as at the time of measurement, cell counts were insignificantly high to be detected as changes in optical density (see Appendix \ref{A:1} for further details.)  
