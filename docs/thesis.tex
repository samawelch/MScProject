...
\midrule
\rowcolor{gggrey}\textbf{Copper} & Heavy Metal & 2000\tnote{t} & Cu(II)Cl\textsubscript{2}, dihydrate (99\%), Alfa Aesar 12458 & Essential nutrient, ROS, enzymes & Efflux, chelation, rapid repair, membrane transition & \cite{Nayar2004EnvironmentalMesocosms,Valko2005MetalsStress,Dupont2011CopperApplications,ECHA2018REACHCopper} \\
...
\rowcolor{gggrey}\textbf{Atrazine} & Pesticide (Herbicide) & 0.25\tnote{t} & Power, analytical, Sigma Aldrich 45330 & ROS, bacterial enzymatic nutrient & Biodegradation & \cite{Shimabukuro1969AtrazineAction,Delorenzo2001TOXICITYREVIEW,Zhang2012OxidativeAtrazine} \\
...
\begin{figure}[ht]
    \centering
    \includegraphics[width = \textwidth]{Scripts/Results/Bug_Rangefinding/growthXrichness.pdf}
